    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="password">Password <span class="text-muted small">(Kosongkan jika tidak diubah)</span></label>
                ...
                <div class="form-group">
                    ...
                    <select name="role" id="role" class="form-control @error('role') is-invalid @enderror" required>
                        ...
                        @foreach ($roles as $role)
                            <option value="{{ $role->rId }}" {{ old('role', $user->role) == $role->rId ? 'selected' : '' }}>
                                {{ $role->rNama }}
                            </option>
                        @endforeach
                    </select>
